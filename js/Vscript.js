...
$(document).ready(function() {
		...
		/* Center child dropdown menu */
		$(".dropdown li").hover(function(){
			var dropDown = $(this).children("ul");
			var ulWidth = dropDown.width();
			var liWidth = $(this).width();
			var posLeft = (liWidth - ulWidth)/2;
			dropDown.css("margin-left",posLeft);		
		});	
		
		/* dropdown slidedown|slideup animation on hover */
		$(function () {    
		  $('.dropdown li').hover(function () {
		...
		/* get height of the content container 
		var blogContentHeight = $('.contentContainer').outerHeight(true);
		alert(blogContentHeight);
		$("#blogContentContainer").css("height", blogContentHeight + 'px');
		*/ 
